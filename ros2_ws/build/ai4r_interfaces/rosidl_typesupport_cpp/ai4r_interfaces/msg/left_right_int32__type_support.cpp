...
static const _LeftRightInt32_type_support_symbol_names_t _LeftRightInt32_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ai4r_interfaces, msg, LeftRightInt32)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ai4r_interfaces, msg, LeftRightInt32)),
  }
};
...
{
  return &::ai4r_interfaces::msg::rosidl_typesupport_cpp::LeftRightInt32_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ai4r_interfaces, msg, LeftRightInt32)() {
  return get_message_type_support_handle<ai4r_interfaces::msg::LeftRightInt32>();
}
