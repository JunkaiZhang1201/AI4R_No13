...
static const _EscAndSteering_type_support_symbol_names_t _EscAndSteering_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ai4r_interfaces, msg, EscAndSteering)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ai4r_interfaces, msg, EscAndSteering)),
  }
};
...
{
  return &::ai4r_interfaces::msg::rosidl_typesupport_cpp::EscAndSteering_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ai4r_interfaces, msg, EscAndSteering)() {
  return get_message_type_support_handle<ai4r_interfaces::msg::EscAndSteering>();
}
