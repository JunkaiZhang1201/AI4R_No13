...
static const _ServoPulseWidth_type_support_symbol_names_t _ServoPulseWidth_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ai4r_interfaces, msg, ServoPulseWidth)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ai4r_interfaces, msg, ServoPulseWidth)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ai4r_interfaces, msg, ServoPulseWidth)() {
  return &::ai4r_interfaces::msg::rosidl_typesupport_c::ServoPulseWidth_message_type_support_handle;
}
