...
ai4r_interfaces__msg__LeftRightFloat32__create()
{
  ...
  ai4r_interfaces__msg__LeftRightFloat32 * msg = (ai4r_interfaces__msg__LeftRightFloat32 *)allocator.allocate(sizeof(ai4r_interfaces__msg__LeftRightFloat32), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ai4r_interfaces__msg__LeftRightFloat32));
  bool success = ai4r_interfaces__msg__LeftRightFloat32__init(msg);
  if (!success) {
...
ai4r_interfaces__msg__LeftRightFloat32__destroy(ai4r_interfaces__msg__LeftRightFloat32 * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ai4r_interfaces__msg__LeftRightFloat32__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ai4r_interfaces__msg__LeftRightFloat32__Sequence__init(ai4r_interfaces__msg__LeftRightFloat32__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ai4r_interfaces__msg__LeftRightFloat32 * data = NULL;

  if (size) {
    data = (ai4r_interfaces__msg__LeftRightFloat32 *)allocator.zero_allocate(size, sizeof(ai4r_interfaces__msg__LeftRightFloat32), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ai4r_interfaces__msg__LeftRightFloat32__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ai4r_interfaces__msg__LeftRightFloat32__fini(&data[i - 1]);
      }
...
ai4r_interfaces__msg__LeftRightFloat32__Sequence__fini(ai4r_interfaces__msg__LeftRightFloat32__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ai4r_interfaces__msg__LeftRightFloat32__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ai4r_interfaces__msg__LeftRightFloat32__Sequence * array = (ai4r_interfaces__msg__LeftRightFloat32__Sequence *)allocator.allocate(sizeof(ai4r_interfaces__msg__LeftRightFloat32__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ai4r_interfaces__msg__LeftRightFloat32__Sequence__init(array, size);
  if (!success) {
...
ai4r_interfaces__msg__LeftRightFloat32__Sequence__destroy(ai4r_interfaces__msg__LeftRightFloat32__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ai4r_interfaces__msg__LeftRightFloat32__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ai4r_interfaces__msg__LeftRightFloat32__Sequence__are_equal(const ai4r_interfaces__msg__LeftRightFloat32__Sequence * lhs, const ai4r_interfaces__msg__LeftRightFloat32__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ai4r_interfaces__msg__LeftRightFloat32__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ai4r_interfaces__msg__LeftRightFloat32__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ai4r_interfaces__msg__LeftRightFloat32);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ai4r_interfaces__msg__LeftRightFloat32 * data =
      (ai4r_interfaces__msg__LeftRightFloat32 *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ai4r_interfaces__msg__LeftRightFloat32__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ai4r_interfaces__msg__LeftRightFloat32__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ai4r_interfaces__msg__LeftRightFloat32__copy(
